...
class FullColorLED:
    ...
    @staticmethod
    def info():
        return AttrDefault(bool, {'name': 'FullColorLED'})
    ...
    def wired(self, obniz):
        ...
        self.pwm_r.start(*[AttrDefault(bool, {'io': r})])
        self.pwm_r.freq(*[1000])
        self.pwm_g = self.obniz.get_free_pwm()
        self.pwm_g.start(*[AttrDefault(bool, {'io': g})])
        self.pwm_g.freq(*[1000])
        self.pwm_b = self.obniz.get_free_pwm()
        self.pwm_b.start(*[AttrDefault(bool, {'io': b})])
    ...
    def gradation(self, cycletime_ms):
        ...
        for i in range(0, max, 1):
            oneFrame = AttrDefault(bool, {'duration': duration, 'state': lambda index: self.hsv(*[index * 10 * 2, 1, 1])})
