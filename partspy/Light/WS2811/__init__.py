class _ws2811:
    ...
    def _generate_color(r, g, b):
        array = _ws2811._generate_from_byte(*[r])
        array = array.concat(*[_ws2811._generate_from_byte(*[g])])
        array = array.concat(*[_ws2811._generate_from_byte(*[b])])
        return array
    ...
    def _generate_hsv_color(h, s, v):
        ...
        array = _ws2811._generate_from_byte(*[_r])
        array = array.concat(*[_ws2811._generate_from_byte(*[_g])])
        array = array.concat(*[_ws2811._generate_from_byte(*[_b])])
        return array

    def rgb(self, r, g, b):
        self.spi.write(*[_ws2811._generate_color(*[r, g, b])])

    def hsv(self, h, s, v):
        self.spi.write(*[_ws2811._generate_hsv_color(*[h, s, v])])
