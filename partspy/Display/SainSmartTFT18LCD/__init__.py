...
class _sain_smart_tft18_lcd:
    def __init__(self):
        self.keys = ['vcc', 'gnd', 'scl', 'sda', 'dc', 'res', 'cs']
        self.required = ['scl', 'sda', 'dc', 'res', 'cs']
        self.display_io_names = {'vcc': 'vcc', 'gnd': 'gnd', 'scl': 'scl', 'sda': 'sda', 'dc': 'dc', 'res': 'res', 'cs': 'cs'}

    @staticmethod
    def info():
        return {'name': 'SainSmartTFT18LCD'}
